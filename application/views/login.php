        ...
        <table>
            <tr>
                <td colspan="3">
		            ...
		            <!-- <h3 style="background-color:#C4EFBF; border:1px solid #66CE5B; display:block; text-align:center; margin:14px 0 14px 0; padding:12px 10px 12px 10px;">Akses Login ke Sistem akan ditutup Setiap Hari Pukul 16:30</h3> -->
                    <!-- <p style='background-color:yellow; border:1px solid #66CE5B; display:block; text-align:center; width:92%; margin:14px 0 14px 0; padding:12px 10px 12px 10px; '>Bagi sekolah yang menghendaki untuk menambah user entri dapat menghubungi <b>Call Center ICT</b> di <b>082245049504</b></p> -->
                </td>
            </tr>
            <tr>
                <td>
