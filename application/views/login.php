...
<div id="sidebar">
    <form method="post" action="<?php echo site_url("home/login");?>">
		...
		<h3 style="background-color:#C4EFBF; border:1px solid #66CE5B; display:block; text-align:center; margin:14px 0 14px 0; padding:12px 10px 12px 10px;">Akses Login ke Sistem akan ditutup Tanggal 16 Juni 2015 Pukul 12:00</h3>
                </td>
            </tr>
            <tr>
                <td>
