                    ...
                    <tr>
                        <td>
                            ...
                            foreach($sekolah as $row) {
                                echo (($this->uri->segment(4) == $row->ID_SEKOLAH) ? ((strpos($this->session->userdata('HAK'), 'inputrekom') !== false || $this->session->userdata('HAK') == 'admin') ? $row->NAMA_SEKOLAH.' - ' : '').$row->JURUSAN : anchor('cari/semua_peserta/x/'.$row->ID_SEKOLAH, ((strpos($this->session->userdata('HAK'), 'inputrekom') !== false || $this->session->userdata('HAK') == 'admin') ? $row->NAMA_SEKOLAH.' - ' : '').$row->JURUSAN))."<br />\r\n";    
                            }
                            ?> 
                            </div>
                        </td>
