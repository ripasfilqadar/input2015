        ...
        <tr>
            <td>
                <table class="tabeldalambesar" border="0" cellspacing="5" cellpadding="0">
                    ...
                    <tr>
                        <td class="style2">Nilai <?php if($tingkatan=='smp')echo "Sekolah"; ?> Bahasa Indonesia</td>
                        <td>:</td>
                        <td><?php echo $UAN_BIND; ?></td>
                    </tr>
                    <tr>
                        <td class="style2">Nilai <?php if($tingkatan=='smp')echo "Sekolah"; ?> Matematika</td>
                        <td>:</td>
                        <td><?php echo $UAN_MAT; ?></td>
                    </tr>
                    <tr>
                        <td class="style2">Nilai <?php if($tingkatan=='smp')echo "Sekolah"; ?> IPA</td>
                        <td>:</td>
                    ...
                    <?php } ?> 
                    <tr>
                        <td class="style2">Total Nilai</td>
                        <td>:</td>
                ...
                <?php echo "<a target='_blank' href=".site_url('pdf/cetak/').'/'.$tingkatan.'/'.$NO_UJIAN."><button>Cetak</button></a>"; ?>
                ...
                <?php echo ($this->session->userdata('HAK') == 'inputrekomsmk') ? anchor('daftar/ntmbntk/'.$NO_UJIAN, 'Input NTMB/NTK', 'style="color: blue;"') : '' ?> 
            </td>
        </tr>
    </table>
</div>
