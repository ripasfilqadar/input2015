                                                ...
                                                <tbody align="center" style="background-color: #ffffff">
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <input id="nilai_bind2" onchange="sum()" name="nilai_bind2" size="7" type="number" step="0.01" style="margin-top: 5px;width:78px" value="<?php echo $pendaftar->RAP_BIND; ?>"<?php echo ($this->uri->segment(2) == 'baru') ? ' disabled="disabled"' : ''; ?> />
                                                        </td>
                                                        <td width="50px">
                                                            ...
                                                            <input id="nilai_mat2" onchange="sum()" name="nilai_mat2" size="7" type="number" step="0.01" style="margin-top: 5px;width:78px" value="<?php echo $pendaftar->RAP_MAT; ?>"<?php echo ($this->uri->segment(2) == 'baru') ? ' disabled="disabled"' : ''; ?> />
                                                        </td>
                                                        <td>
                                                            ...
                                                            <input id="nilai_ipa2" onchange="sum()" name="nilai_ipa2" size="7" type="number" step="0.01" style="margin-top: 5px;width:78px" value="<?php echo $pendaftar->RAP_IPA; ?>"<?php echo ($this->uri->segment(2) == 'baru') ? ' disabled="disabled"' : ''; ?> /></td>
