            ...
            <td>
                <table class="tabeldalambesar" cellpadding="0" cellspacing="0" width="580px;">
                    <tr>
                        <td align="center">
                            <!-- Start Input (Pilihan) -->
                            <form class="formbesar" action="<?php echo site_url('daftar/'.$this->uri->segment(2).'/'.$tingkatan.'/'.$NO_UJIAN.'/2'); ?>" method="post">
                                ...
                                <table id="input_pilihan" class="tabeldalamform" cellpadding="1" cellspacing="2">
                                    ...
                                    <tr>
                                        ...
                                        <td class="tddfkanan"><?php echo $NAMA_ORTU; ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tddfkanan"><?php echo $NO_TELP; ?></td>
                                    </tr>
                                    <tr id="row_psiko">
                                    ...
                                    <tr>
                                        ...
                                        <td class="tddfkanan"><?php echo $ALASAN_PERUBAHAN; ?></td>
                                    </tr>
                                    <tr>
                                        <td class="tddfkiri">&nbsp;</td>
                                        <td class="tddfkanan">
                                            <input id="simpan" type="submit" name="act" value="Simpan" onclick="return confirm('Anda yakin data yang sudah diisikan benar?');" style="border: solid thin #123412"/>
