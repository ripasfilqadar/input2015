            ...
            <td>
                <table class="tabeldalambesar" border="0" cellspacing="5" cellpadding="0" style="vertical-align: top;">
                    ...
                    <tr>
                        ...
                        {
                            echo 'nyamnyam '.$item->NAMA_SEKOLAH;
                        }*/
                        
                        if ($NO_TINGKATAN != '3' && !strpos($hak,'rekom')) echo $sekolah[$ID_SEKOLAH]->NAMA_SEKOLAH; 
                        //echo $ID_SEKOLAH;
                        else {
                            for ($i = $start = intval($ID_SEKOLAH)*1000; $i < $start + 1000; $i++) {
                                //echo 'halo '.$i;
                                if (isset($sekolah[$i])) {
