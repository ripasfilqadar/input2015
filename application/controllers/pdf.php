...
class Pdf extends CI_Controller {
    ...
    public function template($pdf, $data, $posY = 0, $statement='Untuk Pendaftar'){
            ...
            $pdf->addPngFromFile("images/dinas2.png",35,$pdf->y-$posY-55);
            // $pdf->addPngFromFile("../images/logo-sidoarjo1.jpg",35,$pdf->y-$posY-55);
            $pdf->addText(150, $pdf->y-$posY-9, 15, $judul1);
            $pdf->addText(215, $pdf->y-$posY-25, 16, $judul2);
            $pdf->addText(178, $pdf->y-$posY-35, 8, $judul3);
            $pdf->addText(80, $pdf->y-$posY-36, 25, "_______________________________");
            $pdf->addText(87, $pdf->y-$posY-38, 30, "_________________________");
